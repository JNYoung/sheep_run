...
const zhCN: TranslationTable = {
  ...
  "menu.rewardHint": "免费标出几只安全小羊",
  "daily.ready": "今日挑战",
  "daily.completed": "今日已完成",
  "daily.title": "第 {level} 关",
  "daily.action": "开始今日挑战",
  "achievement.summary": "成就 {done}/{total} · 星星 {stars} · 最佳连胜 {streak}",
  "tutorial.title": "新手引导",
  "tutorial.step1": "先点发光的小羊。它前方没有阻挡，会沿箭头跑进羊圈。",
  "tutorial.step2": "做得对。继续找箭头能通向边界的小羊；点错只会扣星，不会立刻重开。",
  "objective.default": "按小羊朝向清路，前方被挡会给出路线提示。",
  ...
  "status.undo": "已撤销上一步，本关最高只能拿到 2 星。",
  "status.tutorialStart": "发光小羊前方畅通，先点它试试。",
  "status.tutorialNext": "继续找能通向边界的小羊。",
  "result.win.title": "成功入仓",
  "result.win.body": "顺序正确，所有小羊都安全进入羊圈。",
  "result.fail.title": "失败",
  "fail.wrongTarget": "点错了，只能点小羊。",
  "fail.missed": "点空了，已记录一次失误。",
  "fail.blocked": "路线被挡住了。",
...
const tables: Record<Locale, TranslationTable> = {
  ...
  "zh-TW": {
    ...
    "menu.rewardHint": "免費標出幾隻安全小羊",
    "daily.ready": "今日挑戰",
    "daily.completed": "今日已完成",
    "daily.title": "第 {level} 關",
    "daily.action": "開始今日挑戰",
    "achievement.summary": "成就 {done}/{total} · 星星 {stars} · 最佳連勝 {streak}",
    "tutorial.title": "新手引導",
    "tutorial.step1": "先點發光的小羊。牠前方沒有阻擋，會沿箭頭跑進羊圈。",
    "tutorial.step2": "做得對。繼續找箭頭能通向邊界的小羊；點錯只會扣星，不會立刻重來。",
    "objective.default": "按小羊朝向清路，前方被擋會給出路線提示。",
    ...
    "status.undo": "已復原上一步，本關最高只能拿到 2 星。",
    "status.tutorialStart": "發光小羊前方暢通，先點牠試試。",
    "status.tutorialNext": "繼續找能通向邊界的小羊。",
    "result.win.title": "成功入倉",
    "result.win.body": "順序正確，所有小羊都安全進入羊圈。",
    "result.fail.title": "失敗",
    "fail.wrongTarget": "點錯了，只能點小羊。",
    "fail.missed": "點空了，已記錄一次失誤。",
    "fail.blocked": "路線被擋住了。",
  ...
  ja: {
    ...
    "menu.rewardHint": "安全なひつじを無料で表示",
    "objective.default": "ひつじの向きに進みます。詰まった道は表示されます。",
    ...
    "fail.missed": "空振りです。ミスが1回記録されました。",
  ...
  fr: {
    ...
    "menu.rewardHint": "Montre gratuitement des moutons sûrs",
    "objective.default": "Suis la direction du mouton. Un chemin bloqué affiche un repère.",
    ...
    "fail.missed": "Appui manqué. Une erreur est notée.",
  ...
  de: {
    ...
    "menu.rewardHint": "Zeigt sichere Schafe kostenlos",
    "objective.default": "Folge der Blickrichtung. Blockierte Wege zeigen einen Hinweis.",
    ...
    "fail.missed": "Daneben. Ein Fehler wurde notiert.",
  ...
  en: {
    ...
    "menu.rewardHint": "Free highlight for safe sheep",
    "daily.ready": "Daily Challenge",
    "daily.completed": "Daily Complete",
    "daily.title": "Level {level}",
    "daily.action": "Start daily challenge",
    "achievement.summary": "Achievements {done}/{total} · Stars {stars} · Best streak {streak}",
    "tutorial.title": "Quick Start",
    "tutorial.step1": "Tap the glowing sheep first. Its lane is open, so it will run into the pen.",
    "tutorial.step2": "Good. Keep finding sheep whose arrows can reach the edge; early misses cost stars instead of ending the run.",
    "objective.default": "Follow each sheep's direction. Blocked paths now show a route cue.",
    ...
    "status.undo": "Last move undone. This level can now earn up to 2 stars.",
    "status.tutorialStart": "The glowing sheep has a clear lane. Tap it first.",
    "status.tutorialNext": "Keep finding sheep with arrows that can reach the edge.",
    "result.win.title": "Barn Reached",
    "result.win.body": "Correct order. Every sheep made it into the pen.",
    "result.fail.title": "Failed",
    "fail.wrongTarget": "Wrong tap. Only sheep can be selected.",
    "fail.missed": "Missed tap. One mistake recorded.",
  ...
  ar: {
    ...
    "menu.rewardHint": "يبرز الخراف الآمنة مجانا",
    "objective.default": "اتبع اتجاه كل خروف. الطريق المسدود يعرض تلميحا.",
    ...
    "fail.missed": "نقرة فارغة. تم تسجيل خطأ واحد.",
